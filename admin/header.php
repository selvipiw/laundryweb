...
<head>
    ...
    <link rel="icon" href="https://png.pngtree.com/template/20190308/ourlarge/pngtree-clean-laundry-icon-image_63960.jpg" type="image/x-icon" />
    <!-- <box-icon type="image/x-icon" name='home' rel="icon"></box-icon> -->
                ...
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                        <li class="nav-item dropdown hidden-caret">
                            ...
                            <div class="avatar-sm">
                                    <img src="../assets/img/download.png" alt="..." class="avatar-img rounded-circle">
                                </div>
                            </a>
                            <ul class="dropdown-menu dropdown-user animated fadeIn">
                                <div class="dropdown-user-scroll scrollbar-outer">
                                    <li>
                                        <div class="user-box">
                                            <div class="avatar-lg"><img src="https://cdn-icons-png.flaticon.com/512/219/219986.png" alt="image profile" class="avatar-img rounded"></div>
                                            <div class="u-text">
            ...
            <div class="sidebar-wrapper scrollbar scrollbar-inner">
                <div class="sidebar-content">
                    ...
                    <ul class="nav nav-primary">
                        <li class="nav-item <?php if ($title == 'Selamat Datang di Aplikasi Pengelolaan Laundry SELVi') {
                                                echo 'active';
                                            } ?>">
